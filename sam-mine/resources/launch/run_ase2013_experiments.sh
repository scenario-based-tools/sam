...
sh ./sam_mine.sh ./experiments_fse2012/crossftp.xes.gz 10 1.0

sh ./sam_mine.sh ./experiments_fse2012/columba.xes.gz 40 1.0
sh ./sam_mine.sh ./experiments_fse2012/columba.xes.gz 20 1.0
sh ./sam_mine.sh ./experiments_fse2012/columba.xes.gz 10 1.0
sh ./sam_mine.sh ./experiments_fse2012/columba.xes.gz 10 0.5
